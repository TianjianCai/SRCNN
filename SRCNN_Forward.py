...
print(sess.run(tf.reduce_mean(tf.squared_difference(img_resized_X, img_decoded)),{batch_start:pic_num,batch_size:1}))
print(sess.run(tf.reduce_mean(tf.squared_difference(l3.out, img_decoded)),{batch_start:pic_num,batch_size:1,keep_prob:1}))
